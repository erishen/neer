...
import server from 'neer/dist/server/next'
import _pkg from 'neer/package.json'
...
export function runNextCommand(argv, options = {}) {
  const nextDir = path.dirname(require.resolve('neer/package'))
...
export function buildTS(args = [], cwd, env = {}) {
  cwd = cwd || path.dirname(require.resolve('neer/package'))
