  ...
  describe('Next Lint', () => {
    describe('First Time Setup ', () => {
      ...
      for (const { packageManger, lockFile } of [
        ...
        test(`installs eslint and eslint-config-neer as devDependencies if missing with ${packageManger}`, async () => {
