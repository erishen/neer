...
describe('Missing _document components error', () => {
  it('should detect missing Html component', async () => {
    await checkMissing(
      ['<Html />'],
      `
      import Document, { Head, Main, NextScript } from 'neer/document'
  ...
  it('should detect missing Main component', async () => {
    await checkMissing(
      ['<Main />'],
      `
      import Document, { Html, Head, NextScript } from 'neer/document'
  ...
  it('should detect missing NextScript component', async () => {
    await checkMissing(
      ['<NextScript />'],
      `
      import Document, { Html, Head, Main } from 'neer/document'
  ...
  it('should detect multiple missing document components', async () => {
    await checkMissing(
      ['<Head />', '<NextScript />'],
      `
      import Document, { Html, Main } from 'neer/document'
