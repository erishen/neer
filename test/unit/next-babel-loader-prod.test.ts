...
import { Span } from 'neer/dist/trace'
import loader from 'neer/dist/build/babel/loader'
  ...
  describe('replace constants', () => {
    ...
    it('should handle no pagesDir', async () => {
      ...
      expect(
        ...
        `"var _jsxFileName = \\"index.js\\";import React from \\"react\\";var __jsx = React.createElement;import dynamic from 'neer/dynamic';const Comp = dynamic(() => import('comp'), {  loadableGenerated: {    webpack: () => [require.resolveWeak('comp')]  }});export default function Page(props) {  return __jsx(Comp, {    __self: this,    __source: {      fileName: _jsxFileName,      lineNumber: 7,      columnNumber: 18    }  });}"`
      )
    })
