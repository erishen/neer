...
import rule from 'eslint-plugin-neer/dist/rules/no-document-import-in-page'
...
ruleTester.run('no-document-import-in-page', rule, {
  valid: [
    {
      code: `import Document from "neer/document"
    ...
    {
      code: `import NextDocument from "neer/document"
    ...
    {
      code: `import NDocument from "neer/document"
