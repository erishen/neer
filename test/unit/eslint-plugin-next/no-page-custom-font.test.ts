import rule from 'eslint-plugin-neer/dist/rules/no-page-custom-font'
...
ruleTester.run('no-page-custom-font', rule, {
  valid: [
    {
      code: `import Document, { Html, Head } from "neer/document";
    ...
    {
      code: `import NextDocument, { Html, Head } from "neer/document";
