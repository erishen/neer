import loader from 'neer-font/google/loader'
import fetch from 'neer/dist/compiled/node-fetch'

jest.mock('neer/dist/compiled/node-fetch')

describe('neer-font/google loader', () => {
  afterEach(() => {
    jest.resetAllMocks()
  })
  ...
  describe('Errors', () => {
    test('Missing function name', async () => {
      await expect(
        ...
        `"neer-font/google has no default export"`
      )
    })
