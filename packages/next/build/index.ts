  ...
  try {
    ...
    const buildResult = await nextBuildSpan.traceAsyncFn(async () => {
      ...
      const initialRequireHookFilePath = require.resolve(
        'neer/dist/server/initialize-require-hook'
      )
      ...
      if (config.outputFileTracing) {
        ...
        if (!nodeFileTrace) {
          nodeFileTrace =
            require('neer/dist/compiled/@vercel/nft').nodeFileTrace
        }
        ...
        await includeExcludeSpan.traceAsyncFn(async () => {
          const globOrig =
            require('neer/dist/compiled/glob') as typeof import('neer/dist/compiled/glob')
        ...
        await nextBuildSpan
          ...
          .traceAsyncFn(async () => {
            ...
            let serverResult: import('neer/dist/compiled/@vercel/nft').NodeFileTraceResult
            if (config.experimental.turbotrace) {
