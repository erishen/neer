...
export function attachReactRefresh(
  ...
  const reactRefreshLoaderName =
    'neer/dist/compiled/@next/react-refresh-utils/dist/loader'
        ...
        ...(dev
          ? {
              [CLIENT_STATIC_FILES_RUNTIME_REACT_REFRESH]: require.resolve(
                `neer/dist/compiled/@next/react-refresh-utils/dist/runtime`
              ),
              [CLIENT_STATIC_FILES_RUNTIME_AMP]:
                `./` +
                path
    ...
    alias: {
      ...
      ...(isEdgeServer
        ? {
            ...
            [require.resolve('neer/dist/client/link')]:
              'neer/dist/esm/client/link',
            [require.resolve('neer/dist/client/image')]:
              'neer/dist/esm/client/image',
            [require.resolve('neer/dist/client/script')]:
              'neer/dist/esm/client/script',
            [require.resolve('neer/dist/client/router')]:
              'neer/dist/esm/client/router',
            [require.resolve('neer/dist/shared/lib/head')]:
              'neer/dist/esm/shared/lib/head',
            [require.resolve('neer/dist/shared/lib/dynamic')]:
              'neer/dist/esm/shared/lib/dynamic',
            [require.resolve('neer/dist/pages/_document')]:
              'neer/dist/esm/pages/_document',
            [require.resolve('neer/dist/pages/_app')]:
              'neer/dist/esm/pages/_app',
            [require.resolve(
              'neer/dist/client/components/navigation'
            )]: 'neer/dist/client/components/navigation',
            [require.resolve('neer/dist/client/components/headers')]:
              'neer/dist/client/components/headers',
          }
        : undefined),

      ...(config.images.loaderFile
        ? {
            'neer/dist/shared/lib/image-loader':
              config.images.loaderFile,
          }
        : undefined),
      ...
      ...(hasServerComponents
        ? {
            ...
            'react-dom/client$':
              'neer/dist/compiled/react-dom/client',
            'react-dom/server$':
              'neer/dist/compiled/react-dom/server',
            'react-dom/server.browser$':
              'neer/dist/compiled/react-dom/server.browser',
            'react/jsx-dev-runtime$':
              'neer/dist/compiled/react/jsx-dev-runtime',
            'react/jsx-runtime$':
              'neer/dist/compiled/react/jsx-runtime',
          }
        : {
            react: reactDir,
      ...
      [RSC_MOD_REF_PROXY_ALIAS]:
        'neer/dist/build/webpack/loaders/next-flight-loader/module-proxy',
  ...
  async function handleExternals(
    ...
    if (layer === WEBPACK_LAYERS.server) {
      if (
        ...
        request ===
          'neer/dist/compiled/react-server-dom-webpack/server.browser'
      ) {
        return
      }
    }
          ...
          ? [
              {
                ...
                resolve: {
                  ...
                  alias: {
                    ...
                    react:
                      'neer/dist/compiled/react/react.shared-subset',
                    'react-dom$':
                      'neer/dist/compiled/react-dom/server-rendering-stub',
                  },
                },
              },
            ]
              ...
              // Alias next/head component to noop for RSC
              {
                ...
                resolve: {
                  alias: {
                    ...
                    [require.resolve('neer/head')]: require.resolve(
                      'neer/dist/client/components/noop-head'
                    ),
                  },
                },
              },
                    ...
                    resolve: {
                      alias: {
                        ...
                        'react-dom$': reactProductionProfiling
                          ? 'neer/dist/compiled/react-dom/cjs/react-dom.profiling.min'
                          : 'neer/dist/compiled/react-dom',
                        'react-dom/client$':
                          'neer/dist/compiled/react-dom/client',
                      },
                    },
                        ...
                        config.experimental.fallbackNodePolyfills === false
                          ...
                          : {
                              assert: require.resolve(
                                'neer/dist/compiled/assert'
                              ),
                              buffer: require.resolve(
                                'neer/dist/compiled/buffer/'
                              ),
                              constants: require.resolve(
                                'neer/dist/compiled/constants-browserify'
                              ),
                              crypto: require.resolve(
                                'neer/dist/compiled/crypto-browserify'
                              ),
                              domain: require.resolve(
                                'neer/dist/compiled/domain-browser'
                              ),
                              http: require.resolve(
                                'neer/dist/compiled/stream-http'
                              ),
                              https: require.resolve(
                                'neer/dist/compiled/https-browserify'
                              ),
                              os: require.resolve(
                                'neer/dist/compiled/os-browserify'
                              ),
                              path: require.resolve(
                                'neer/dist/compiled/path-browserify'
                              ),
                              punycode: require.resolve(
                                'neer/dist/compiled/punycode'
                              ),
                              process: require.resolve('./polyfills/process'),
                              // Handled in separate alias
                              querystring: require.resolve(
                                'neer/dist/compiled/querystring-es3'
                              ),
                              stream: require.resolve(
                                'neer/dist/compiled/stream-browserify'
                              ),
                              string_decoder: require.resolve(
                                'neer/dist/compiled/string_decoder'
                              ),
                              sys: require.resolve(
                                'neer/dist/compiled/util/'
                              ),
                              timers: require.resolve(
                                'neer/dist/compiled/timers-browserify'
                              ),
                              tty: require.resolve(
                                'neer/dist/compiled/tty-browserify'
                              ),
                              // Handled in separate alias
                              ...
                              vm: require.resolve(
                                'neer/dist/compiled/vm-browserify'
                              ),
                              zlib: require.resolve(
                                'neer/dist/compiled/browserify-zlib'
                              ),
                              events: require.resolve(
                                'neer/dist/compiled/events/'
                              ),
                              setImmediate: require.resolve(
                                'neer/dist/compiled/setimmediate'
                              ),
                            },
                    },
                  },
