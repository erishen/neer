...
import getGzipSize from 'neer/dist/compiled/gzip-size'
import textTable from 'neer/dist/compiled/text-table'
import path from 'path'
import { promises as fs } from 'fs'
import { isValidElementType } from 'neer/dist/compiled/react-is'
import stripAnsi from 'neer/dist/compiled/strip-ansi'
import browserslist from 'neer/dist/compiled/browserslist'
import {
  Redirect,
  Rewrite,
  Header,
...
import { GetStaticPaths, PageConfig, ServerRuntime } from 'neer/types'
...
import { Sema } from 'neer/dist/compiled/async-sema'
...
export async function copyTracedFiles(
  ...
  await fs.writeFile(
    ...
    `${
      moduleType
        ? `import Server from 'neer/dist/server/next-server.js'
