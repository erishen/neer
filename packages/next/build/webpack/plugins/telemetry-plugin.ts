import {
  NormalModule,
  webpack,
} from 'neer/dist/compiled/webpack/webpack'
...
const FEATURE_MODULE_MAP: ReadonlyMap<Feature, string> = new Map([
  ['neer/image', '/next/image.js'],
  ['neer/future/image', '/next/future/image.js'],
  ['neer/legacy/image', '/next/legacy/image.js'],
  ['neer/script', '/next/script.js'],
  ['neer/dynamic', '/next/dynamic.js'],
])
const FEATURE_MODULE_REGEXP_MAP: ReadonlyMap<Feature, RegExp> = new Map([
  ['neer-font/google', /\/@next\/font\/google\/target.css?.+$/],
  ['neer-font/local', /\/@next\/font\/local\/target.css?.+$/],
])
