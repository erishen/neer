...
import { gte as semverGte } from 'neer/dist/compiled/semver'
  ...
  if (path?.length) {
    ...
    if (validateResult.errors) {
      ...
      const { AggregateAjvError } =
        require('neer/dist/compiled/@segment/ajv-human-errors') as typeof import('neer/dist/compiled/@segment/ajv-human-errors')
