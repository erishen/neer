...
import {
  ...
  getSourceById,
  parseStack,
} from 'neer/dist/compiled/@next/react-dev-overlay/dist/middleware'
...
const ReactDevOverlay = (props: any) => {
  if (ReactDevOverlayImpl === undefined) {
    ReactDevOverlayImpl =
      require('neer/dist/compiled/@next/react-dev-overlay/dist/client').ReactDevOverlay
  }
  ...
  constructor(options: Options) {
    ...
    ;(this.renderOpts as any).ampValidator = (
      ...
      const AmpHtmlValidator =
        require('neer/dist/compiled/amphtml-validator') as typeof import('neer/dist/compiled/amphtml-validator')
