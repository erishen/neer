...
function noRouter() {
  const message =
    'No router instance found. you should only use "neer/router" inside the client side of your app. https://nextjs.org/docs/messages/no-router-instance'
...
function errorToJSON(err: Error) {
  ...
  if (process.env.NEXT_RUNTIME !== 'edge') {
    source =
      require('neer/dist/compiled/@next/react-dev-overlay/dist/middleware').getErrorSource(
        err
      ) || 'server'
  }
...
export async function renderToHTML(
  ...
  if (dev) {
    const {
      isValidElementType,
    } = require('neer/dist/compiled/react-is')
