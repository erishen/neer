...
import compression from 'neer/dist/compiled/compression'
...
export default class NextNodeServer extends BaseServer {
  ...
  protected async proxyRequest(
    ...
    const HttpProxy =
      require('neer/dist/compiled/http-proxy') as typeof import('neer/dist/compiled/http-proxy')
  ...
  protected async runEdgeFunction(params: {
    ...
    if (result.response.body) {
      ...
      const { consumeUint8ArrayReadableStream } =
        require('neer/dist/compiled/edge-runtime') as typeof import('neer/dist/compiled/edge-runtime')
      try {
