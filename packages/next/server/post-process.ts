...
import type { HTMLElement } from 'neer/dist/compiled/node-html-parser'
...
async function processHTML(
  ...
  const { parse } =
    require('neer/dist/compiled/node-html-parser') as typeof import('neer/dist/compiled/node-html-parser')
