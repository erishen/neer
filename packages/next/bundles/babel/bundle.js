...
function eslintParser() {
  return require('neer/dist/compiled/babel-packages').eslintParser()
}

function pluginProposalClassProperties() {
  return require('neer/dist/compiled/babel-packages').pluginProposalClassProperties()
}

function pluginProposalExportNamespaceFrom() {
  return require('neer/dist/compiled/babel-packages').pluginProposalExportNamespaceFrom()
}

function pluginProposalNumericSeparator() {
  return require('neer/dist/compiled/babel-packages').pluginProposalNumericSeparator()
}

function pluginProposalObjectRestSpread() {
  return require('neer/dist/compiled/babel-packages').pluginProposalObjectRestSpread()
}

function pluginSyntaxBigint() {
  return require('neer/dist/compiled/babel-packages').pluginSyntaxBigint()
}

function pluginSyntaxDynamicImport() {
  return require('neer/dist/compiled/babel-packages').pluginSyntaxDynamicImport()
}

function pluginSyntaxImportAssertions() {
  return require('neer/dist/compiled/babel-packages').pluginSyntaxImportAssertions()
}

function pluginSyntaxJsx() {
  return require('neer/dist/compiled/babel-packages').pluginSyntaxJsx()
}

function pluginTransformDefine() {
  return require('neer/dist/compiled/babel-packages').pluginTransformDefine()
}

function pluginTransformModulesCommonjs() {
  return require('neer/dist/compiled/babel-packages').pluginTransformModulesCommonjs()
}

function pluginTransformReactRemovePropTypes() {
  return require('neer/dist/compiled/babel-packages').pluginTransformReactRemovePropTypes()
}

function pluginTransformRuntime() {
  return require('neer/dist/compiled/babel-packages').pluginTransformRuntime()
}

function presetEnv() {
  return require('neer/dist/compiled/babel-packages').presetEnv()
}

function presetReact() {
  return require('neer/dist/compiled/babel-packages').presetReact()
}

function presetTypescript() {
  return require('neer/dist/compiled/babel-packages').presetTypescript()
}
