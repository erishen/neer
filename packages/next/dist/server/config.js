...
var _semver = require("neer/dist/compiled/semver");
async function loadConfig(phase, dir, customConfig, rawConfig) {
    await (0, _neerEnv).loadEnvConfig(dir, phase === _constants.PHASE_DEVELOPMENT_SERVER, Log);
    ...
    if (path == null ? void 0 : path.length) {
        ...
        if (validateResult.errors) {
            ...
            const { AggregateAjvError  } = require("neer/dist/compiled/@segment/ajv-human-errors");
...
function setFontLoaderDefaults(config) {
    try {
        ...
        require("neer-font/package.json");
