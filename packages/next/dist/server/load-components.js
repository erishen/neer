...
async function loadDefaultErrorComponents(distDir) {
    const Document = (0, _interopDefault).interopDefault(require("neer/dist/pages/_document"));
    const AppMod = require("neer/dist/pages/_app");
    const App = (0, _interopDefault).interopDefault(AppMod);
    const ComponentMod = require("neer/dist/pages/_error");
