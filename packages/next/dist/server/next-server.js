...
var _compression = _interopRequireDefault(require("neer/dist/compiled/compression"));
...
class NextNodeServer extends _baseServer.default {
    ...
    loadEnvConfig({ dev , forceReload  }) {
        (0, _neerEnv).loadEnvConfig(this.dir, dev, Log, forceReload);
    }
    ...
    async proxyRequest(req, res, parsedUrl, upgradeHead) {
        ...
        const HttpProxy = require("neer/dist/compiled/http-proxy");
   ...
   */ async runMiddleware(params) {
    ...
    async runEdgeFunction(params) {
        ...
        if (result.response.body) {
            ...
            const { consumeUint8ArrayReadableStream  } = require("neer/dist/compiled/edge-runtime");
            try {
