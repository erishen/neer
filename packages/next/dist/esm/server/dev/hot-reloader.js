import { webpack, StringXor } from "neer/dist/compiled/webpack/webpack";
import { getOverlayMiddleware } from "neer/dist/compiled/@next/react-dev-overlay/dist/middleware";
...
import ws from "neer/dist/compiled/ws";
    ...
    async buildFallbackError() {
        ...
        const fallbackConfig = await getBaseWebpackConfig(this.dir, {
            ...
            entrypoints: (await createEntrypoints({
                ...
                isDev: true,
                pages: {
                    "/_app": "neer/dist/pages/_app",
                    "/_error": "neer/dist/pages/_error"
                },
                pagesDir: this.pagesDir,
                previewMode: this.previewProps,
                rootDir: this.dir,
