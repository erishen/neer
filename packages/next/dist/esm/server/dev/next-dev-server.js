...
import fs from "fs";
import { Worker } from "neer/dist/compiled/jest-worker";
import findUp from "neer/dist/compiled/find-up";
import { join as pathJoin, relative, resolve as pathResolve, sep } from "path";
import Watchpack from "neer/dist/compiled/watchpack";
...
import { createOriginalStackFrame, getErrorSource, getSourceById, parseStack } from "neer/dist/compiled/@next/react-dev-overlay/dist/middleware";
...
const ReactDevOverlay = (props)=>{
    if (ReactDevOverlayImpl === undefined) {
        ReactDevOverlayImpl = require("neer/dist/compiled/@next/react-dev-overlay/dist/client").ReactDevOverlay;
    }
...
export default class DevServer extends Server {
    ...
    constructor(options){
        ...
        this.renderOpts.ampValidator = (html, pathname)=>{
            ...
            const AmpHtmlValidator = require("neer/dist/compiled/amphtml-validator");
