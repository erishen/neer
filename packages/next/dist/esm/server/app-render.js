...
import React, { use } from "neer/dist/compiled/react";
import { NotFound as DefaultNotFound } from "../client/components/error";
// this needs to be required lazily so that `next-server` can set
// the env before we require
import ReactDOMServer from "neer/dist/compiled/react-dom/server.browser";
...
import stringHash from "neer/dist/compiled/string-hash";
