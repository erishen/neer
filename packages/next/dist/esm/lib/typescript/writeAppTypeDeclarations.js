...
export async function writeAppTypeDeclarations(baseDir, imageImportsEnabled) {
    ...
    const content = '/// <reference types="next" />' + eol + (imageImportsEnabled ? '/// <reference types="neer/image-types/global" />' + eol : "") + eol + "// NOTE: This file should not be edited" + eol + "// see https://nextjs.org/docs/basic-features/typescript for more information." + eol;
