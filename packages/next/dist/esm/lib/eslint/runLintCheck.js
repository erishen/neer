...
import semver from "neer/dist/compiled/semver";
import * as CommentJson from "neer/dist/compiled/comment-json";
    ...
    try {
        ...
        return {
            ...
            eventInfo: {
                ...
                lintFix: !!options.fix,
                nextEslintPluginVersion: nextEslintPluginIsEnabled && deps.resolved.has("eslint-config-neer") ? require(path.join(path.dirname(deps.resolved.get("eslint-config-neer")), "package.json")).version : null,
