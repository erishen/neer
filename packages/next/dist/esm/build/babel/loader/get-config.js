...
import JSON5 from "neer/dist/compiled/json5";
import { createConfigItem, loadOptions } from "neer/dist/compiled/babel/core";
import loadConfig from "neer/dist/compiled/babel/core-lib-config";
 ...
 */ function getPlugins(loaderOptions, cacheCharacteristics) {
    ...
    const reactRefreshItem = hasReactRefresh ? createConfigItem([
        require("neer/dist/compiled/react-refresh/babel"),
        {
            skipEnvCheck: true
        }, 
    ], {
    ...
    const transformDefineItem = createConfigItem([
        require.resolve("neer/dist/compiled/babel/plugin-transform-define"),
        {
    ...
    const commonJsItem = isNextDist ? createConfigItem(require("neer/dist/compiled/babel/plugin-transform-modules-commonjs"), {
        type: "plugin"
    }) : null;
