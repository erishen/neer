...
import ReactRefreshWebpackPlugin from "neer/dist/compiled/@next/react-refresh-utils/dist/ReactRefreshWebpackPlugin";
...
export default async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =COMPILER_NAMES.server , appDir , middlewareMatchers , noMangling =false  }) {
    ...
    const clientEntries = isClient ? {
        ...
        "main.js": [],
        ...dev ? {
            [CLIENT_STATIC_FILES_RUNTIME_REACT_REFRESH]: require.resolve(`neer/dist/compiled/@next/react-refresh-utils/dist/runtime`),
    ...
    const resolveConfig = {
        ...
        alias: {
            ...
            [RSC_MOD_REF_PROXY_ALIAS]: "neer/dist/build/webpack/loaders/next-flight-loader/module-proxy",
