...
import { platformArchTriples } from "neer/dist/compiled/@napi-rs/triples";
import * as Log from "../output/log";
import { getParserOptions } from "./options";
import { eventSwcLoadFailure } from "../../telemetry/events/swc-load-failure";
import { patchIncorrectLockfile } from "../../lib/patch-incorrect-lockfile";
import { downloadWasmSwc } from "../../lib/download-wasm-swc";
import { version as nextVersion } from "neer/package.json";
const ArchName = arch();
...
async function tryLoadWasmWithFallback(attempts) {
    ...
    try {
        ...
        const wasmDirectory = path.join(path.dirname(require.resolve("neer/package.json")), "wasm");
                ...
                startDev: (options)=>{
                    ...
                    if (!isCustomTurbopack) {
                        ...
                        return new Promise((resolve, reject)=>{
                            const spawn = require("neer/dist/compiled/cross-spawn");
                            const args = [];
