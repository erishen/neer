...
const nextAppLoader = async function nextAppLoader() {
    ...
    export { default as AppRouter } from 'neer/dist/client/components/app-router'
    export { default as LayoutRouter } from 'neer/dist/client/components/layout-router'
    export { default as RenderFromTemplateContext } from 'neer/dist/client/components/render-from-template-context'
    export { default as GlobalError } from ${JSON.stringify(globalError || "neer/dist/client/components/error-boundary")}

    export { staticGenerationAsyncStorage } from 'neer/dist/client/components/static-generation-async-storage'
    export { requestAsyncStorage } from 'neer/dist/client/components/request-async-storage'

    export * as serverHooks from 'neer/dist/client/components/hooks-server-context'

    export { renderToReadableStream } from 'neer/dist/compiled/react-server-dom-webpack/server.browser'
