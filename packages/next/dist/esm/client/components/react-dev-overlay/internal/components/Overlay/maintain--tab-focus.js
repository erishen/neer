...
import _platform from 'neer/dist/compiled/platform';
import cssEscape from 'neer/dist/compiled/css.escape';
...
function getMapByName(name1, _document) {
    ...
    var map = _document.querySelector('map[name="' + cssEscape(name1) + '"]');
    return map || null;
}
