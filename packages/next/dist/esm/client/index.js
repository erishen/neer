...
class Container extends React.Component {
    ...
    render() {
        if (process.env.NODE_ENV === 'production') {
            ...
            const { ReactDevOverlay ,  } = require('neer/dist/compiled/@next/react-dev-overlay/dist/client');
...
function _hydrate() {
    _hydrate = _async_to_generator(function*(opts) {
        ...
        if (process.env.NODE_ENV === 'development') {
            const { getServerError ,  } = require('neer/dist/compiled/@next/react-dev-overlay/dist/client');
