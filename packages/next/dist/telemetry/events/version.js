...
function hasBabelConfig(dir) {
    try {
        ...
        const res = require("neer/dist/compiled/babel/core").loadPartialConfig({
            cwd: dir,
            filename: noopFile,
        ...
        const isForTooling = ((ref4 = res.options) == null ? void 0 : (ref1 = ref4.presets) == null ? void 0 : ref1.every((e)=>{
            var ref;
            return (e == null ? void 0 : (ref = e.file) == null ? void 0 : ref.request) === "neer/babel";
