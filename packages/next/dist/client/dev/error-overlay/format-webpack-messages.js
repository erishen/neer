...
var _stripAnsi = _interop_require_default(require("neer/dist/compiled/strip-ansi"));
...
function formatWebpackMessages(json, verbose) {
    const formattedErrors = json.errors.map(function(message) {
        const isUnknownNextFontError = message.message.includes('An error occured in `neer-font`.');
