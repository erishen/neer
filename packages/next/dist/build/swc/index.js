...
var _os = require("os");
var _triples = require("neer/dist/compiled/@napi-rs/triples");
...
var _packageJson = require("neer/package.json");
...
async function tryLoadWasmWithFallback(attempts) {
    ...
    try {
        ...
        const wasmDirectory = _path.default.join(_path.default.dirname(require.resolve("neer/package.json")), "wasm");
