...
var _reactRefreshWebpackPlugin = _interopRequireDefault(require("neer/dist/compiled/@next/react-refresh-utils/dist/ReactRefreshWebpackPlugin"));
...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =_constants1.COMPILER_NAMES.server , appDir , middlewareMatchers , noMangling =false  }) {
    ...
    const clientEntries = isClient ? {
        ...
        "main.js": [],
        ...dev ? {
            [_constants1.CLIENT_STATIC_FILES_RUNTIME_REACT_REFRESH]: require.resolve(`neer/dist/compiled/@next/react-refresh-utils/dist/runtime`),
        ...
        ...hasAppDir ? {
            [_constants1.CLIENT_STATIC_FILES_RUNTIME_MAIN_APP]: dev ? [
                require.resolve(`neer/dist/compiled/@next/react-refresh-utils/dist/runtime`),
    ...
    if (dev) {
        const nextDist = "neer/dist/" + (isEdgeServer ? "esm/" : "");
    ...
    const resolveConfig = {
        ...
        alias: {
            ...
            ...isEdgeServer ? {
                "neer/dist/client": "neer/dist/esm/client",
                "neer/dist/shared": "neer/dist/esm/shared",
                "neer/dist/pages": "neer/dist/esm/pages",
                "neer/dist/lib": "neer/dist/esm/lib",
                // Alias the usage of next public APIs
                [require.resolve("neer/dist/client/link")]: "neer/dist/esm/client/link",
                [require.resolve("neer/dist/client/image")]: "neer/dist/esm/client/image",
                [require.resolve("neer/dist/client/script")]: "neer/dist/esm/client/script",
                [require.resolve("neer/dist/client/router")]: "neer/dist/esm/client/router",
                [require.resolve("neer/dist/shared/lib/head")]: "neer/dist/esm/shared/lib/head",
                [require.resolve("neer/dist/shared/lib/dynamic")]: "neer/dist/esm/shared/lib/dynamic",
                [require.resolve("neer/dist/pages/_document")]: "neer/dist/esm/pages/_document",
                [require.resolve("neer/dist/pages/_app")]: "neer/dist/esm/pages/_app",
                [require.resolve("neer/dist/client/components/navigation")]: "neer/dist/client/components/navigation",
                [require.resolve("neer/dist/client/components/headers")]: "neer/dist/client/components/headers"
            } : undefined,
            ...config.images.loaderFile ? {
                "neer/dist/shared/lib/image-loader": config.images.loaderFile
            } : undefined,
            next: NEXT_PROJECT_ROOT,
            ...hasServerComponents ? {
                // For react and react-dom, alias them dynamically for server layer
                // and others in the loaders configuration
                "react-dom/client$": "neer/dist/compiled/react-dom/client",
                "react-dom/server$": "neer/dist/compiled/react-dom/server",
                "react-dom/server.browser$": "neer/dist/compiled/react-dom/server.browser",
                "react/jsx-dev-runtime$": "neer/dist/compiled/react/jsx-dev-runtime",
                "react/jsx-runtime$": "neer/dist/compiled/react/jsx-runtime"
            } : {
                react: reactDir,
            ...
            [_constants.RSC_MOD_REF_PROXY_ALIAS]: "neer/dist/build/webpack/loaders/next-flight-loader/module-proxy",
    ...
    async function handleExternals(context, request, dependencyType, layer, getResolve) {
        ...
        // in pages/components
        if (request === "next") {
            return `commonjs neer/dist/lib/import-next-warning`;
        }
        // Special internal modules that must be bundled for Server Components.
        if (layer === _constants.WEBPACK_LAYERS.server) {
            if (reactPackagesRegex.test(request) || request === "neer/dist/compiled/react-server-dom-webpack/server.browser") {
                return;
            }
        }
        ...
        if (!isLocal) {
            ...
            if (/^(react(?:$|\/)|react-dom(?:$|\/))/.test(request)) {
                ...
                return `commonjs ${hasAppDir ? "neer/dist/compiled/" : ""}${request}`;
            }
        ...
        if (/node_modules[/\\].*\.[mc]?js$/.test(res)) {
            ...
            if (layer === _constants.WEBPACK_LAYERS.client) {
                if (reactPackagesRegex.test(request)) {
                    return `commonjs neer/dist/compiled/${request}`;
                }
                return;
            }
            ...
            ...isEdgeServer ? [
                {
                    ...
                    "neer/dist/compiled/etag": "{}",
                    "neer/dist/compiled/chalk": "{}",
                ...
                ...hasAppDir && !isClient ? [
                    {
                        ...
                        resolve: {
                            ...
                            alias: {
                                ...
                                react: "neer/dist/compiled/react/react.shared-subset",
                                "react-dom$": "neer/dist/compiled/react-dom/server-rendering-stub"
                            }
                        }
                    }, 
                ] : [],
                    ...
                    // Alias next/head component to noop for RSC
                    {
                        ...
                        resolve: {
                            alias: {
                                ...
                                [require.resolve("neer/head")]: require.resolve("neer/dist/client/components/noop-head")
                            }
                        }
                    },
                    {
                        ...
                        oneOf: [
                            ...
                            },
                            {
                                ...
                                resolve: {
                                    alias: {
                                        react: "neer/dist/compiled/react",
                                        "react-dom$": "neer/dist/compiled/react-dom/server-rendering-stub"
                                    }
                                }
                            },
                            {
                                ...
                                resolve: {
                                    alias: {
                                        react: "neer/dist/compiled/react",
                                        "react-dom$": reactProductionProfiling ? "neer/dist/compiled/react-dom/cjs/react-dom.profiling.min" : "neer/dist/compiled/react-dom",
                                        "react-dom/client$": "neer/dist/compiled/react-dom/client"
                                    }
                                }
                            }, 
                ...
                },
                {
                    oneOf: [
                        ...
                        ] : [],
                        {
                            ...codeCondition,
                            use: dev && isClient ? [
                                require.resolve("neer/dist/compiled/@next/react-refresh-utils/dist/loader"),
                            ...
                            },
                            {
                                resolve: {
                                    fallback: config.experimental.fallbackNodePolyfills === false ? {
                                        ...
                                        assert: require.resolve("neer/dist/compiled/assert"),
                                        buffer: require.resolve("neer/dist/compiled/buffer/"),
                                        constants: require.resolve("neer/dist/compiled/constants-browserify"),
                                        crypto: require.resolve("neer/dist/compiled/crypto-browserify"),
                                        domain: require.resolve("neer/dist/compiled/domain-browser"),
                                        http: require.resolve("neer/dist/compiled/stream-http"),
                                        https: require.resolve("neer/dist/compiled/https-browserify"),
                                        os: require.resolve("neer/dist/compiled/os-browserify"),
                                        path: require.resolve("neer/dist/compiled/path-browserify"),
                                        punycode: require.resolve("neer/dist/compiled/punycode"),
                                        process: require.resolve("./polyfills/process"),
                                        // Handled in separate alias
                                        querystring: require.resolve("neer/dist/compiled/querystring-es3"),
                                        stream: require.resolve("neer/dist/compiled/stream-browserify"),
                                        string_decoder: require.resolve("neer/dist/compiled/string_decoder"),
                                        sys: require.resolve("neer/dist/compiled/util/"),
                                        timers: require.resolve("neer/dist/compiled/timers-browserify"),
                                        tty: require.resolve("neer/dist/compiled/tty-browserify"),
                                        // Handled in separate alias
                                        // url: require.resolve('url/'),
                                        util: require.resolve("neer/dist/compiled/util/"),
                                        vm: require.resolve("neer/dist/compiled/vm-browserify"),
                                        zlib: require.resolve("neer/dist/compiled/browserify-zlib"),
                                        events: require.resolve("neer/dist/compiled/events/"),
                                        setImmediate: require.resolve("neer/dist/compiled/setimmediate")
                                    }
                                }
                            }, 
                        ]
...
function getOptimizedAliases() {
    ...
    return Object.assign({}, {
        ...
        url: require.resolve("neer/dist/compiled/native-url")
    });
}
function attachReactRefresh(webpackConfig, targetLoader) {
    var ref, ref45;
    let injections = 0;
    const reactRefreshLoaderName = "neer/dist/compiled/@next/react-refresh-utils/dist/loader";
