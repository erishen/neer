...
var _gzipSize = _interopRequireDefault(require("neer/dist/compiled/gzip-size"));
var _textTable = _interopRequireDefault(require("neer/dist/compiled/text-table"));
var _path = _interopRequireDefault(require("path"));
var _fs = require("fs");
var _reactIs = require("neer/dist/compiled/react-is");
var _stripAnsi = _interopRequireDefault(require("neer/dist/compiled/strip-ansi"));
var _browserslist = _interopRequireDefault(require("neer/dist/compiled/browserslist"));
...
var _asyncSema = require("neer/dist/compiled/async-sema");
...
async function copyTracedFiles(dir, distDir, pageKeys, appPageKeys, tracingRoot, serverConfig, middlewareManifest) {
    ...
    await _fs.promises.writeFile(serverOutputPath, `${moduleType ? `import Server from 'neer/dist/server/next-server.js'
import http from 'http'
import path from 'path'
import { fileURLToPath } from 'url'
const __dirname = fileURLToPath(new URL('.', import.meta.url))
const NextServer = Server.default` : `
const NextServer = require('neer/dist/server/next-server').default
