...
export declare function getDefineEnv({ dev, config, distDir, isClient, hasRewrites, isNodeServer, isEdgeServer, middlewareMatchers, }: {
    dev?: boolean;
    distDir: string;
    isClient?: boolean;
    hasRewrites?: boolean;
...
export default function getBaseWebpackConfig(dir: string, { buildId, config, compilerType, dev, entrypoints, isDevFallback, pagesDir, reactProductionProfiling, rewrites, runWebpackSpan, target, appDir, middlewareMatchers, noMangling, }: {
    buildId: string;
    config: NextConfigComplete;
