...
function overrideBuiltInReactPackages() {
    setRequireOverrides([
        [
            "react",
            require.resolve("neer/dist/compiled/react")
        ],
        [
            "react/jsx-runtime",
            require.resolve("neer/dist/compiled/react/jsx-runtime"), 
        ],
        [
            "react/jsx-dev-runtime",
            require.resolve("neer/dist/compiled/react/jsx-dev-runtime"), 
        ],
        [
            "react-dom",
            require.resolve("neer/dist/compiled/react-dom/server-rendering-stub"), 
        ],
        [
            "react-dom/client",
            require.resolve("neer/dist/compiled/react-dom/client"), 
        ],
        [
            "react-dom/server",
            require.resolve("neer/dist/compiled/react-dom/server"), 
        ],
        [
            "react-dom/server.browser",
            require.resolve("neer/dist/compiled/react-dom/server.browser"), 
        ], 
    ]);
}
