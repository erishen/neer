...
var _neerEnv = require("neer-env");
var _chalk = _interopRequireDefault(require("neer/dist/compiled/chalk"));
var _crypto = _interopRequireDefault(require("crypto"));
var _micromatch = require("neer/dist/compiled/micromatch");
var _fs = require("fs");
var _jestWorker = require("neer/dist/compiled/jest-worker");
var _worker = require("../lib/worker");
var _devalue = _interopRequireDefault(require("neer/dist/compiled/devalue"));
var _escapeRegexp = require("../shared/lib/escape-regexp");
var _findUp = _interopRequireDefault(require("neer/dist/compiled/find-up"));
var _indexCjs = require("neer/dist/compiled/nanoid/index.cjs");
var _pathToRegexp = require("neer/dist/compiled/path-to-regexp");
...
async function build(dir, conf = null, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false) {
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            const { loadedEnvFiles  } = nextBuildSpan.traceChild("load-dotenv").traceFn(()=>(0, _neerEnv).loadEnvConfig(dir, false, Log));
            ...
            const initialRequireHookFilePath = require.resolve("neer/dist/server/initialize-require-hook");
            ...
            if (!hasSsrAmpPages1) {
                requiredServerFiles.ignore.push(_path.default.relative(dir, _path.default.join(_path.default.dirname(require.resolve("neer/dist/compiled/@ampproject/toolbox-optimizer")), "**/*")));
            }
            if (config.outputFileTracing) {
                let nodeFileTrace;
                ...
                if (!nodeFileTrace) {
                    nodeFileTrace = require("neer/dist/compiled/@vercel/nft").nodeFileTrace;
                }
                const includeExcludeSpan = nextBuildSpan.traceChild("apply-include-excludes");
                await includeExcludeSpan.traceAsyncFn(async ()=>{
                    const globOrig = require("neer/dist/compiled/glob");
                    const glob = (pattern)=>{
                ...
                await nextBuildSpan.traceChild("trace-next-server").traceAsyncFn(async ()=>{
                    ...
                    if (lockFiles.length > 0) {
                        ...
                        cacheHash.update(require("neer/package").version);
                    ...
                    const toTrace = [
                        require.resolve("neer/dist/server/next-server"), 
                    ];
                    ...
                    if (config.experimental.turbotrace) {
                        ...
                        const ignores = [
                            "**/neer/dist/pages/**/*",
                            "**/neer/dist/compiled/webpack/(bundle4|bundle5).js",
                            "**/node_modules/webpack5/**/*",
                            "**/neer/dist/server/lib/squoosh/**/*.wasm",
                            ...ciEnvironment.hasNextSupport ? [
                                // only ignore image-optimizer code when
                                // this is being handled outside of next-server
                                "**/neer/dist/server/image-optimizer.js",
                                "**/node_modules/sharp/**/*", 
                            ] : [],
                            ...!hasSsrAmpPages1 ? [
...
/**
 * typescript will be loaded in "neer/lib/verifyTypeScriptSetup" and
 * then passed to "neer/lib/typescript/runTypeCheck" as a parameter.
 *
 * Since it is impossible to pass a function from main thread to a worker,
 * instead of running "neer/lib/typescript/runTypeCheck" in a worker,
 * we will run entire "neer/lib/verifyTypeScriptSetup" in a worker instead.
