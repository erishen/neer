...
var _core = require("neer/dist/compiled/babel/core");
var _coreLibConfig = _interopRequireDefault(require("neer/dist/compiled/babel/core-lib-config"));
 ...
 */ function getPlugins(loaderOptions, cacheCharacteristics) {
    ...
    const commonJsItem = isNextDist ? (0, _core).createConfigItem(require("neer/dist/compiled/babel/plugin-transform-modules-commonjs"), {
        type: "plugin"
    }) : null;
