                    ...
                    if expr.args.is_empty() {
                        HANDLER.with(|handler| {
                            handler
                                .struct_span_err(
                                    identifier.span,
                                    "neer/dynamic requires at least one argument",
                                )
                                .emit()
                        });
                        return expr;
                        ...
                        HANDLER.with(|handler| {
                            handler
                                .struct_span_err(
                                    identifier.span,
                                    "neer/dynamic only accepts 2 arguments",
                                )
                                .emit()
                        });
                        return expr;
