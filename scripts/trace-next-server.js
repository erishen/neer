...
const gzipSize = require('neer/dist/compiled/gzip-size')
const { nodeFileTrace } = require('neer/dist/compiled/@vercel/nft')
const { linkPackages } =
...
async function main() {
  ...
  const nextServerPath = path.join(
    workDir,
    'node_modules/neer/dist/server/next-server.js'
  )
  ...
  const result = await nodeFileTrace([nextServerPath], {
    ...
    processCwd: workDir,
    ignore: [
      'node_modules/neer/dist/pages/**/*',
      'node_modules/neer/dist/server/image-optimizer.js',
      'node_modules/neer/dist/compiled/@ampproject/toolbox-optimizer/**/*',
      'node_modules/neer/dist/server/lib/squoosh/**/*.wasm',
      'node_modules/neer/dist/compiled/webpack/(bundle4|bundle5).js',
